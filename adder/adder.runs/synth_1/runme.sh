...
HD_PWD='D:/vivadoproject/adder/adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder32_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder32_display.tcl
